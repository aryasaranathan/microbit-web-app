...
function sendConfig() {
    let config = {
        ...
        series: [
            { displayName: "Accel X", name: "accelX", color: "#ff0000", symbol: "cross" },
            { displayName: "Accel Y", name: "accelY", color: "#00ff00", symbol: "cross" },
            { displayName: "Accel Z", name: "accelZ", color: "#0000ff", symbol: "cross" }
        ]
    };
